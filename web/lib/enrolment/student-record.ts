...
export type StudentRecordSnapshot = {
  ...
  guardians: Array<{ kind: string; title: string | null; gender: string | null; first_name: string; last_name: string; relationship: string; email: string | null; mobile: string | null; phone: string | null; address: string | null; nationality: string | null }>;
...
export function buildStudentRecord(
  ...
  return {
    ...
    guardians: bundle.contacts
      ...
      .map((c) => ({ kind: c.kind, title: c.title ?? null, gender: c.gender ?? null, first_name: c.first_name, last_name: c.last_name, relationship: c.relationship, email: c.email, mobile: c.mobile_normalised ?? c.mobile, phone: c.phone, address: c.address, nationality: c.nationality })),
