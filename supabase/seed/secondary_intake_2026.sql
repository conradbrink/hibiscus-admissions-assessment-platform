...
Lucy jolted awake, panting from the peculiar dream. She pulled the bedclothes close and stared into the darkness. Was the door open? She knew it had been closed every night, but now...$t$)
  ...
  -- Part A (10 marks)
  q := pg_temp.add_q(v_bank, c_comp, v_passage, 'extended_text', 'Part A. What sound might Lucy have heard if she had been awake in her attic bedroom? (1 mark)', 1, 130, 130);
  perform pg_temp.add_rubric(q, 'Form 1 English A1', c_comp, 1, pg_temp.bands1('A skylark singing high above the house.'));
  eng1 := eng1 || q;

  q := pg_temp.add_q(v_bank, c_comp, v_passage, 'extended_text', 'Part A. What sensations does Lucy experience as she senses someone climbing the attic stairs in her nightmare? (1 mark)', 1, 130, 130);
  ...
  q := pg_temp.add_q(v_bank, c_comp, v_passage, 'extended_text', 'Part A. Initially, what does Lucy think the dreadful figure in her dream resembles, and what does she eventually realise? (2 marks)', 2, 130, 130);
  ...
  q := pg_temp.add_q(v_bank, c_comp, v_passage, 'extended_text', 'Part A. What does the girl in Lucy''s dream cry out to her, and how does Lucy respond to this? (2 marks)', 2, 130, 130);
  ...
  q := pg_temp.add_q(v_bank, c_comp, v_passage, 'extended_text', 'Part A. After waking up, what is Lucy''s concern regarding the state of her bedroom door, and what does this indicate about her feelings? (2 marks)', 2, 130, 130);
...
$t$Part A. This line describes part of the setting at the beginning of the story. Look at the underlined words:
...
Tick the TWO techniques being used here. (2 marks)$t$, 2, 130, 130);
  ...
  -- Part B (6 marks)
  q := pg_temp.add_q(v_bank, c_gram, v_passage, 'extended_text', 'Part B. Identify the subject and the verb in the sentence: "Lucy was trapped in a nightmare." (2 marks)', 2, 130, 130);
  ...
  q := pg_temp.add_q(v_bank, c_gram, v_passage, 'short_text', 'Part B. What tense is used in the sentence "The room remained dark and silent"? (1 mark)', 1, 130, 130);
  ...
  q := pg_temp.add_q(v_bank, c_gram, v_passage, 'single_choice', 'Part B. In the phrase "a dreadful figure, initially resembling a seal covered in oil," what part of speech is the word "dreadful"? (1 mark)', 1, 130, 130);
  perform pg_temp.add_choice(q, array['preposition', 'adjective', 'verb'], array[2]);
  eng1 := eng1 || q;

  q := pg_temp.add_q(v_bank, c_gram, v_passage, 'short_text', 'Part B. What is the present tense of "jolted" in the sentence "Lucy jolted awake, panting from the peculiar dream"? (1 mark)', 1, 130, 130);
  perform pg_temp.add_short(q, array['jolts', 'jolt']);
  eng1 := eng1 || q;

  q := pg_temp.add_q(v_bank, c_gram, v_passage, 'single_choice', 'Part B. What type of sentence is "Was the door open?" (1 mark)', 1, 130, 130);
...
These frogs are mainly nocturnal, spending the day resting among leaves. They become active in the evenings, calling with their high-pitched, loud voices while inflating their throat pouches.$t$)
  ...
  -- Part A (10 marks)
  q := pg_temp.add_q(v_bank, c_comp, v_passage, 'extended_text', 'Part A. What are two popular choices for beginners starting with tree frogs? (2 marks)', 2, 140, 140);
  ...
  q := pg_temp.add_q(v_bank, c_comp, v_passage, 'extended_text', 'Part A. What makes the American green tree frog a suitable option for novice keepers? (1 mark)', 1, 140, 140);
  perform pg_temp.add_rubric(q, 'Form 2 English A2', c_comp, 1, pg_temp.bands1('It is hardy and easy to care for.'));
  eng2 := eng2 || q;

  q := pg_temp.add_q(v_bank, c_comp, v_passage, 'extended_text', 'Part A. Where is the American green tree frog native to, and what types of habitats does it prefer? (2 marks)', 2, 140, 140);
  ...
  q := pg_temp.add_q(v_bank, c_comp, v_passage, 'extended_text', 'Part A. How does the size of the American green tree frog compare to its European cousin? (1 mark)', 1, 140, 140);
  ...
  q := pg_temp.add_q(v_bank, c_comp, v_passage, 'extended_text', 'Part A. What are the characteristics of the American green tree frog''s behaviour? (1 mark)', 1, 140, 140);
  ...
  q := pg_temp.add_q(v_bank, c_read, v_passage, 'extended_text', 'Part A. Identify an example of personification in the passage. (1 mark)', 1, 140, 140);
  ...
  q := pg_temp.add_q(v_bank, c_read, v_passage, 'extended_text', 'Part A. Use the following figures of speech to answer: imagery, hyperbole, metaphor.
...
Find an example of imagery in the passage. (1 mark)', 1, 140, 140);
  ...
  q := pg_temp.add_q(v_bank, c_read, v_passage, 'single_choice', 'Part A. Use the following figures of speech to answer: imagery, hyperbole, metaphor.
...
What figure of speech is used in the phrase "the large and placid White''s tree frog or the iconic red-eyed tree frog"? (1 mark)', 1, 140, 140);
  ...
  -- Part B (5 marks)
  q := pg_temp.add_q(v_bank, c_gram, v_passage, 'short_text', 'Part B. Identify the subject in the sentence: "The American green tree frog is vibrant, typically apple green with tiny white or yellow speckles." (1 mark)', 1, 140, 140);
  ...
  q := pg_temp.add_q(v_bank, c_gram, v_passage, 'short_text', 'Part B. What verb tense is used in the sentence "Captive-bred specimens can be found at exotic pet retailers"? (1 mark)', 1, 140, 140);
  ...
  q := pg_temp.add_q(v_bank, c_gram, v_passage, 'short_text', 'Part B. In the phrase "when starting with tree frogs," what part of speech is "tree frogs"? (1 mark)', 1, 140, 140);
  ...
  q := pg_temp.add_q(v_bank, c_gram, v_passage, 'extended_text', 'Part B. Rewrite the sentence "They become active in the evenings, calling with their high-pitched, loud voices" by changing it to the passive voice. (1 mark)', 1, 140, 140);
  ...
  q := pg_temp.add_q(v_bank, c_gram, v_passage, 'extended_text', 'Part B. What type of sentence is "For something more unusual, consider the American green tree frog," and what makes it that type? Choose from: command, question, suggestion, statement. (1 mark)', 1, 140, 140);
...
Yusuf, the skipper, guided us past mangroves and hidden sandbanks using modern navigation tools, while the crew sang songs to the ship, celebrating their cherished vessel as we cruised towards the remote beauty of Kiwayu and the Kiunga Marine National Reserve.$t$)
  ...
  q := pg_temp.add_q(v_bank, c_comp, v_passage, 'extended_text', 'Part A. What traditional method is used in the construction of fishing dhows on Lamu Island? (1 mark)', 1, 150, 150);
  ...
  q := pg_temp.add_q(v_bank, c_comp, v_passage, 'extended_text', 'Part A. What is the significance of the name "Tusitiri," and what features make it suitable for the charter trade? (2 marks)', 2, 150, 150);
  ...
  q := pg_temp.add_q(v_bank, c_comp, v_passage, 'extended_text', 'Part A. Describe the setting during the narrator''s voyage on Tusitiri. (2 marks)', 2, 150, 150);
  ...
  q := pg_temp.add_q(v_bank, c_comp, v_passage, 'extended_text', 'Part A. How did Yusuf, the skipper, navigate during the journey? (1 mark)', 1, 150, 150);
  ...
  q := pg_temp.add_q(v_bank, c_comp, v_passage, 'extended_text', 'Part A. What activities did the crew engage in while on the voyage, and what does this suggest about their relationship with the ship? (2 marks)', 2, 150, 150);
  ...
  q := pg_temp.add_q(v_bank, c_gram, v_passage, 'short_text', 'Part B. In the sentence "Fishing dhows are still built on Lamu Island," what tense is the verb "are built" in? (1 mark)', 1, 150, 150);
  ...
  q := pg_temp.add_q(v_bank, c_gram, v_passage, 'single_choice', 'Part B. Choose the correct form of the verb to fill in the blank: "The crew __________ songs to the ship." (1 mark)', 1, 150, 150);
  ...
  q := pg_temp.add_q(v_bank, c_gram, v_passage, 'short_text', 'Part B. In the passage, to what does the pronoun "it" in the sentence "It now sails as far as Mozambique" refer? (1 mark)', 1, 150, 150);
  ...
  q := pg_temp.add_q(v_bank, c_gram, v_passage, 'short_text', 'Part B. Identify the adjective in the phrase "hand-carved Lamu chairs." (1 mark)', 1, 150, 150);
  perform pg_temp.add_short(q, array['hand-carved', 'hand carved', 'handcarved', 'hand-carved lamu', 'lamu']);
  eng3 := eng3 || q;

  q := pg_temp.add_q(v_bank, c_gram, v_passage, 'single_choice', 'Part B. Sentence structure: which of the following sentences is a complex sentence? (1 mark)', 1, 150, 150);
...
People rushed to help, asking where I was hit, and I discovered my right arm was paralyzed. Oddly, I felt satisfaction, thinking this would please my wife, as she had always wished for me to be wounded to avoid worse fates. After being informed that the bullet went through my throat, I assumed I wouldn’t survive. In those blurry moments, I thought of my wife and felt resentment for leaving this world due to careless fate. I even wondered about the shooter, feeling no animosity towards him.$t$)
  ...
  q := pg_temp.add_q(v_bank, c_comp, v_passage, 'extended_text', 'Part A. What time of day is described in the passage, and why is it considered dangerous? (2 marks)', 2, 160, 170);
  ...
  q := pg_temp.add_q(v_bank, c_comp, v_passage, 'extended_text', 'Part A. How did the speaker describe the experience of being hit by a bullet? (1 mark)', 1, 160, 170);
  ...
  q := pg_temp.add_q(v_bank, c_comp, v_passage, 'extended_text', 'Part A. What physical effect did the bullet have on the speaker''s body? (1 mark)', 1, 160, 170);
  ...
  q := pg_temp.add_q(v_bank, c_comp, v_passage, 'extended_text', 'Part A. What thoughts did the speaker have about their wife in the moments following the injury? (1 mark)', 1, 160, 170);
  ...
  q := pg_temp.add_q(v_bank, c_comp, v_passage, 'extended_text', 'Part A. What emotions did the speaker experience regarding their fate after being shot? (1 mark)', 1, 160, 170);
  ...
  q := pg_temp.add_q(v_bank, c_gram, v_passage, 'short_text', 'Part B. In the sentence "I suddenly felt a shock, akin to being at the centre of an explosion," what tense is the verb "felt" in? (1 mark)', 1, 160, 170);
  ...
  q := pg_temp.add_q(v_bank, c_gram, v_passage, 'single_choice', 'Part B. Choose the correct form to complete the sentence: "The experience of being hit by a bullet __________ striking and worth describing." (1 mark)', 1, 160, 170);
  perform pg_temp.add_choice(q, array['are', 'is', 'were', 'be'], array[2]);
  eng4 := eng4 || q;

  q := pg_temp.add_q(v_bank, c_gram, v_passage, 'short_text', 'Part B. In the passage, to whom does the pronoun "him" in the phrase "I even wondered about the shooter, feeling no animosity towards him" refer? (1 mark)', 1, 160, 170);
  ...
  q := pg_temp.add_q(v_bank, c_read, v_passage, 'extended_text', 'Part B. In the sentence "I suddenly felt a shock, akin to being at the centre of an explosion," what literary device is used, and what does it compare the shock to? (1 mark)', 1, 160, 170);
  ...
  q := pg_temp.add_q(v_bank, c_read, v_passage, 'extended_text', 'Part B. What type of imagery is present in the phrase "a loud bang, a blinding flash," and how does it contribute to the reader''s understanding of the experience? (2 marks)', 2, 160, 170);
  ...
  q := pg_temp.add_q(v_bank, c_read, v_passage, 'extended_text', 'Part B. In the phrase "I fell, hitting the ground, but without pain," how is the concept of "the ground" personified, and what effect does it produce? (2 marks)', 2, 160, 170);
...
$t$Part C. Describe, in a six-sentence paragraph, an experience you had in which you were either (a) very scared or (b) very excited. (20 marks)$t$, 20, 160, 170);
  ...
  -- =========================================================================
  q := pg_temp.add_q(v_bank, c_geom, null, 'single_choice', 'A triangle with all equal sides is called', 1, 130, 130);
  perform pg_temp.add_choice(q, array['Scalene', 'Isosceles', 'Equilateral', 'Kite'], array[3]); mat1 := mat1 || q;
  q := pg_temp.add_q(v_bank, c_geom, null, 'single_choice', 'Angles in a triangle add up to', 1, 130, 130);
  perform pg_temp.add_choice(q, array['90 degrees', '180 degrees', '270 degrees', '360 degrees'], array[2]); mat1 := mat1 || q;
  q := pg_temp.add_q(v_bank, c_num, null, 'single_choice', 'Which of the following is an even number?', 1, 130, 130);
  perform pg_temp.add_choice(q, array['1', '2', '9', '37'], array[2]); mat1 := mat1 || q;
  q := pg_temp.add_q(v_bank, c_num, null, 'single_choice', 'Which of the following is a factor of 12?', 1, 130, 130);
  ...
  q := pg_temp.add_q(v_bank, c_num, null, 'single_choice', 'Which of the following is a prime number?', 1, 130, 130);
  perform pg_temp.add_choice(q, array['1', '9', '19', '27'], array[3]); mat1 := mat1 || q;
  q := pg_temp.add_q(v_bank, c_num, null, 'single_choice', 'Which of the following is a square number?', 1, 130, 130);
  ...
  q := pg_temp.add_q(v_bank, c_geom, null, 'single_choice', 'The formula ½ base × height is used to find the area of', 1, 130, 130);
  perform pg_temp.add_choice(q, array['triangle', 'circle', 'rectangle', 'square'], array[1]); mat1 := mat1 || q;
  q := pg_temp.add_q(v_bank, c_patt, null, 'single_choice', 'a + a + a + a is equal to', 1, 130, 130);
  perform pg_temp.add_choice(q, array['a × a × a', '4a', '4 − a', 'a⁴'], array[2]); mat1 := mat1 || q;
  q := pg_temp.add_q(v_bank, c_geom, null, 'single_choice', 'Any shape with 4 sides is called a', 1, 130, 130);
  perform pg_temp.add_choice(q, array['Pentagon', 'Square', 'Triangle', 'Quadrilateral'], array[4]); mat1 := mat1 || q;
  q := pg_temp.add_q(v_bank, c_arith, null, 'single_choice', 'The product of 3 and 5 is', 1, 130, 130);
  perform pg_temp.add_choice(q, array['8', '2', '15', '⅗'], array[3]); mat1 := mat1 || q;
  -- Section B (2 marks each)
  q := pg_temp.add_q(v_bank, c_arith, null, 'numeric', 'Section B. Find 25% of 300 pula. Type the number only. (2 marks)', 2, 130, 130);
  perform pg_temp.add_num(q, 75); mat1 := mat1 || q;
  q := pg_temp.add_q(v_bank, c_num, null, 'extended_text', 'Section B. Convert 26/4 to a mixed fraction. (2 marks)', 2, 130, 130);
  ...
  q := pg_temp.add_q(v_bank, c_num, null, 'extended_text', 'Section B. Express 12 as a product of its prime factors. (2 marks)', 2, 130, 130);
  ...
  q := pg_temp.add_q(v_bank, c_arith, null, 'numeric', 'Section B. 3948 + 7938. Type the number only. (2 marks)', 2, 130, 130);
  perform pg_temp.add_num(q, 11886); mat1 := mat1 || q;
  q := pg_temp.add_q(v_bank, c_patt, null, 'extended_text', 'Section B. Write the next 2 terms in this sequence: 4, 7, 10, 13, ……, …… (2 marks)', 2, 130, 130);
  ...
  -- =========================================================================
  q := pg_temp.add_q(v_bank, c_num, null, 'single_choice', 'What is the value of 3 in the number 201.305?', 1, 140, 140);
  perform pg_temp.add_choice(q, array['Hundreds', 'Tens', 'Units', 'Tenths'], array[4]); mat2 := mat2 || q;
  q := pg_temp.add_q(v_bank, c_num, null, 'single_choice', 'Which is the first significant figure in the number 0.00348?', 1, 140, 140);
  perform pg_temp.add_choice(q, array['0', '3', '4', '8'], array[2]); mat2 := mat2 || q;
  q := pg_temp.add_q(v_bank, c_num, null, 'single_choice', 'Round off 164.56 to the nearest 10', 1, 140, 140);
  perform pg_temp.add_choice(q, array['164', '160', '165', '164.6'], array[2]); mat2 := mat2 || q;
  q := pg_temp.add_q(v_bank, c_arith, null, 'single_choice', 'The value of 13² is', 1, 140, 140);
  perform pg_temp.add_choice(q, array['26', '46', '169', '149'], array[3]); mat2 := mat2 || q;
  q := pg_temp.add_q(v_bank, c_arith, null, 'single_choice', 'The value of √144 is', 1, 140, 140);
  perform pg_temp.add_choice(q, array['44', '12', '14', '16'], array[2]); mat2 := mat2 || q;
  q := pg_temp.add_q(v_bank, c_num, null, 'single_choice', 'The following is an example of an odd square number', 1, 140, 140);
  perform pg_temp.add_choice(q, array['4', '9', '27', '16'], array[2]); mat2 := mat2 || q;
  q := pg_temp.add_q(v_bank, c_geom, null, 'single_choice', 'The sum of angles in a right-angled triangle is', 1, 140, 140);
  perform pg_temp.add_choice(q, array['90 degrees', '360 degrees', '270 degrees', '180 degrees'], array[4]); mat2 := mat2 || q;
  q := pg_temp.add_q(v_bank, c_patt, null, 'single_choice', 'The value of 2a² × 3 is', 1, 140, 140);
  perform pg_temp.add_choice(q, array['5a²', '6a', '6a²', '23a²'], array[3]); mat2 := mat2 || q;
  q := pg_temp.add_q(v_bank, c_patt, null, 'single_choice', 'a × a × a =', 1, 140, 140);
  perform pg_temp.add_choice(q, array['3a', 'a³', '3a³', 'a'], array[2]); mat2 := mat2 || q;
  q := pg_temp.add_q(v_bank, c_num, null, 'single_choice', 'The value of 10⁰ is', 1, 140, 140);
  perform pg_temp.add_choice(q, array['100', '10', '0', '1'], array[4]); mat2 := mat2 || q;
  -- Section B (2 marks each)
  q := pg_temp.add_q(v_bank, c_patt, null, 'extended_text', 'Section B. Simplify: 2a + 3b + 3a − 2b = (2 marks)', 2, 140, 140);
  ...
  q := pg_temp.add_q(v_bank, c_patt, null, 'numeric', 'Section B. Evaluate a² − b² when a = 4 and b = 3. Type the number only. (2 marks)', 2, 140, 140);
  perform pg_temp.add_num(q, 7); mat2 := mat2 || q;
  q := pg_temp.add_q(v_bank, c_patt, null, 'extended_text', 'Section B. Simplify: ab + ba = (2 marks)', 2, 140, 140);
  ...
  q := pg_temp.add_q(v_bank, c_patt, null, 'numeric', 'Section B. Find x if 3x = 12. Type the number only. (2 marks)', 2, 140, 140);
  perform pg_temp.add_num(q, 4); mat2 := mat2 || q;
  q := pg_temp.add_q(v_bank, c_prob, null, 'numeric', 'Section B. Change 2 m² to cm². Type the number only. (2 marks)', 2, 140, 140);
  perform pg_temp.add_num(q, 20000); mat2 := mat2 || q;

  -- =========================================================================
  -- Mathematics: Form 3 entrance test (sort 150)
  -- =========================================================================
  q := pg_temp.add_q(v_bank, c_prob, null, 'single_choice', 'How many mm are there in 1 m 1 cm?', 1, 150, 150);
  perform pg_temp.add_choice(q, array['100', '1110', '1010', '1100'], array[3]); mat3 := mat3 || q;
  q := pg_temp.add_q(v_bank, c_geom, null, 'single_choice', 'The longest side in a right-angled triangle is called', 1, 150, 150);
  perform pg_temp.add_choice(q, array['adjacent side', 'opposite side', 'the hypotenuse', 'chord'], array[3]); mat3 := mat3 || q;
  q := pg_temp.add_q(v_bank, c_patt, null, 'single_choice', 'Find the value of n if 5/n = 2.5', 1, 150, 150);
  perform pg_temp.add_choice(q, array['1', '2', '−2', '0.2'], array[2]); mat3 := mat3 || q;
  q := pg_temp.add_q(v_bank, c_patt, null, 'single_choice', 'If 5x − 2 = 3x + 8 then x =', 1, 150, 150);
  perform pg_temp.add_choice(q, array['10', '5', '−5', '3'], array[2]); mat3 := mat3 || q;
  q := pg_temp.add_q(v_bank, c_num, null, 'single_choice', 'How many prime numbers are there between 30 and 40?', 1, 150, 150);
  perform pg_temp.add_choice(q, array['0', '1', '2', '3'], array[3]); mat3 := mat3 || q;
  q := pg_temp.add_q(v_bank, c_num, null, 'single_choice', 'If 5ˣ = 120, the best approximate solution is x =', 1, 150, 150);
  perform pg_temp.add_choice(q, array['2', '3', '4', '25'], array[2]); mat3 := mat3 || q;
  q := pg_temp.add_q(v_bank, c_arith, null, 'single_choice', '800 decreased by 5% is', 1, 150, 150);
  perform pg_temp.add_choice(q, array['795', '540', '760', '400'], array[3]); mat3 := mat3 || q;
  q := pg_temp.add_q(v_bank, c_geom, null, 'single_choice', 'The perimeter of a square is 36 cm. What is its area?', 1, 150, 150);
  perform pg_temp.add_choice(q, array['36 cm²', '324 cm²', '81 cm²', '9 cm²'], array[3]); mat3 := mat3 || q;
  q := pg_temp.add_q(v_bank, c_geom, null, 'single_choice', 'The line dividing a circle into 2 equal halves is called a', 1, 150, 150);
  perform pg_temp.add_choice(q, array['radius', 'tangent', 'diameter', 'chord'], array[3]); mat3 := mat3 || q;
  q := pg_temp.add_q(v_bank, c_prob, null, 'single_choice', 'If 600 pula is shared in the ratio 1:4, the smallest share will be', 1, 150, 150);
  perform pg_temp.add_choice(q, array['150', '120', '200', '1 200'], array[2]); mat3 := mat3 || q;
  -- Section B (2 marks each)
  q := pg_temp.add_q(v_bank, c_prob, null, 'numeric', 'Section B. What is the new fare when the old fare of 250 is increased by 8%? Type the number only. (2 marks)', 2, 150, 150);
  perform pg_temp.add_num(q, 270); mat3 := mat3 || q;
  q := pg_temp.add_q(v_bank, c_patt, null, 'numeric', 'Section B. Evaluate a² + b² when a = 4 and b = −3. Type the number only. (2 marks)', 2, 150, 150);
  perform pg_temp.add_num(q, 25); mat3 := mat3 || q;
  q := pg_temp.add_q(v_bank, c_patt, null, 'extended_text', 'Section B. Expand 2a(4 − a). (2 marks)', 2, 150, 150);
  ...
  q := pg_temp.add_q(v_bank, c_num, null, 'numeric', 'Section B. Find the cube root of 64 × 27. Type the number only. (2 marks)', 2, 150, 150);
  perform pg_temp.add_num(q, 12); mat3 := mat3 || q;
  q := pg_temp.add_q(v_bank, c_prob, null, 'extended_text', 'Section B. Find the median and the mode of these 5 numbers: 5, 2, 11, 2, 8 (2 marks)', 2, 150, 150);
  ...
  q := pg_temp.add_q(v_bank, c_patt, null, 'single_choice', 'The gradient of the line y = 3x − 3 is', 1, 160, 170);
  perform pg_temp.add_choice(q, array['−3', '3', 'y', 'x'], array[2]); mat4 := mat4 || q;
  q := pg_temp.add_q(v_bank, c_prob, null, 'single_choice', 'A school employs 1 200 people of whom 240 are men. The percentage of employees who are men is', 1, 160, 170);
  perform pg_temp.add_choice(q, array['40%', '10%', '15%', '20%'], array[4]); mat4 := mat4 || q;
  q := pg_temp.add_q(v_bank, c_geom, null, 'single_choice', 'The 3 angles in a triangle are 2x, 3x and x. The largest angle is', 1, 160, 170);
  perform pg_temp.add_choice(q, array['30 degrees', '90 degrees', '120 degrees', '80 degrees'], array[2]); mat4 := mat4 || q;
  q := pg_temp.add_q(v_bank, c_num, null, 'single_choice', 'Given that a = ⅗, b = ⅓ and c = ½, then', 1, 160, 170);
  perform pg_temp.add_choice(q, array['a > b > c', 'a > c > b', 'a < b < c', 'a < c < b'], array[2]); mat4 := mat4 || q;
  q := pg_temp.add_q(v_bank, c_geom, null, 'single_choice', 'The larger angle between south-west and east is', 1, 160, 170);
  perform pg_temp.add_choice(q, array['225 degrees', '240 degrees', '135 degrees', '316 degrees'], array[1]); mat4 := mat4 || q;
  q := pg_temp.add_q(v_bank, c_geom, null, 'single_choice', 'Each exterior angle of a regular polygon with n sides is 10°. n =', 1, 160, 170);
  ...
  q := pg_temp.add_q(v_bank, c_num, null, 'single_choice', 'What is the value of 1 − 0.05 as a fraction?', 1, 160, 170);
  perform pg_temp.add_choice(q, array['1/20', '9/10', '19/20', '5/100'], array[3]); mat4 := mat4 || q;
  q := pg_temp.add_q(v_bank, c_patt, null, 'single_choice', 'What is the value of the expression (x − 2)(x + 4) when x = −1?', 1, 160, 170);
  perform pg_temp.add_choice(q, array['−9', '9', '−5', '5'], array[1]); mat4 := mat4 || q;
  q := pg_temp.add_q(v_bank, c_prob, null, 'single_choice', 'A school has 400 students of whom 250 are boys. The ratio of boys to girls is', 1, 160, 170);
  perform pg_temp.add_choice(q, array['5:3', '3:2', '3:5', '8:5'], array[1]); mat4 := mat4 || q;
  q := pg_temp.add_q(v_bank, c_num, null, 'single_choice', 'The approximate value of 9.65 × 0.203 divided by 0.0198 is', 1, 160, 170);
  perform pg_temp.add_choice(q, array['100', '10', '1', '180'], array[1]); mat4 := mat4 || q;
  -- Section B (2 marks each)
  q := pg_temp.add_q(v_bank, c_prob, null, 'extended_text', 'Section B. The price of a television changed from $340 to $300. Calculate the percentage change. (2 marks)', 2, 160, 170);
  ...
  q := pg_temp.add_q(v_bank, c_geom, null, 'numeric', 'Section B. The bearing of A from B is 120°. Calculate the bearing of B from A. Type the number only. (2 marks)', 2, 160, 170);
  perform pg_temp.add_num(q, 300); mat4 := mat4 || q;
  q := pg_temp.add_q(v_bank, c_patt, null, 'numeric', 'Section B. Numbers m, x and y satisfy the equation y = mx². When m = ½ and x = 4, find the value of y. Type the number only. (2 marks)', 2, 160, 170);
  perform pg_temp.add_num(q, 8); mat4 := mat4 || q;
  q := pg_temp.add_q(v_bank, c_prob, null, 'numeric', 'Section B. Joy invested 8 000 pula at a rate of 5% simple interest for 6 years. Calculate the interest earned during that period. Type the number only. (2 marks)', 2, 160, 170);
  perform pg_temp.add_num(q, 2400); mat4 := mat4 || q;
  q := pg_temp.add_q(v_bank, c_prob, null, 'numeric', 'Section B. A straight line is 4.5 cm long. Calculate ⅔ of this line, in cm. Type the number only. (2 marks)', 2, 160, 170);
